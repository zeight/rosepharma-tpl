		...
		<footer id="colophon" class="site-footer columns-wrapper">
			<div class="box col-4">
				...
				if ( $rosepharma_description || is_customize_preview() ) :
					?>
					<p class="site-description"><?php echo $rosepharma_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
				<?php endif; ?></p>
				<p>ROSE PHARMA SA</p>
			...
			<div class="box col-4">
				<div class="site-info">
					...
					<ul>
						...
						<li><a href="<?php echo get_permalink( get_page_by_path( 'cookies' ) ) ?>">Cookie Policy</a></li>
					</ul>
