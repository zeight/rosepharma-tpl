      ...
      <div class="container">
        <div class="columns-wrapper display-section odd mobile-reverse">
          ...
          <div class="box col-5">
            ...
            <a class="body-link" href="#"><span>Our products</span></a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="container full section-2">
      <div class="container">
        <div class="columns-wrapper display-section even">
          <div class="box col-5 ">
            <h2>Professionals</h2>
            <p>Enter a world of beauty, care and premium products for your skin. Rose Pharma develops safe treatments
              for the daily routine, effective cosmetics and professional solutoins to be you - at your best.</p>
            <a class="body-link" href="#"><span>Professionals area</span></a>
          </div>
          ...
          <div class="box col-5 ">
            ...
            <a class="body-link" href="#"><span>Distributors area</span></a>
          </div>
        </div>
      </div>
    </section>
