...
const projectURL = 'rosepharma.wordpress.test';
...
const textDomain = 'ROSEPHARMA';

// Name of the translation file.
const translationFile = 'ROSEPHARMA.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'ROSEPHARMA';

// Where can users report bugs.
const bugReport = 'https://AhmadAwais.com/contact/';

// Last translator Email ID.
const lastTranslator = 'Andrea Zotti <and.zotti@gmail.com>';

// Team's Email ID.
const team = 'Andrea Zotti <and.zotti@gmail.com>';
